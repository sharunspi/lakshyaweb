window.onload = function () {
  ...
  function controlCurrent(nextId) {
      var current = nextId;
...
var Slider = function () {
  function Slider(el) {
    ...
    window.addEventListener('keypress',function (e) {keyp(e)});
  ...
  _createClass(Slider, [{
    ...
    key: 'getMouseCoefficients',
    value: function getMouseCoefficients() {
    ...
    value: function runAnimation() {
      ...
      var _getMouseCoefficients = this.getMouseCoefficients({
        ...
        pageY: newPos.y
          ...
          xCoeff = _getMouseCoefficients.xCoeff,
          yCoeff = _getMouseCoefficients.yCoeff;
    ...
    key: 'positionImage',
    value: function positionImage(_ref5) {
    ...
    key: 'onDotClick',
    value: function onDotClick(_ref6) {
    ...
    key: 'transitionItem',
    value: function transitionItem(nextId) {
      var _this = this;
    ...
    key: 'startTransition',
    value: function startTransition(nextId) {
    ...
    key: 'switchBackgroundImage',
    value: function switchBackgroundImage(nextId) {
